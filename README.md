...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=23&duration=2500&pause=900&color=3B82F6&center=true&vCenter=true&width=980&lines=Data+%26+AI+Engineer+%7C+MSc+Artificial+Intelligence;ETL%2FELT+%7C+Automation+%7C+MLOps+%7C+Data+Visualization;Building+impactful+AI%2FData+solutions+for+real+business+use+cases)](https://git.io/typing-svg)
...
- 🔍 Looking for an AI/Data internship (Ile-de-France)
...
- 🌱 **GreenDC Audit Platform**: PUE/DCiE/CO2 computation, explainable AI recommendations, before/after simulation.
- 🛠️ **IT Ticketing DevOps Platform**: Docker, Docker Compose, Jenkins, CI/CD, backend/frontend/infrastructure roles.
...
- 🤖 **Louvre Chatbot Project**: conversational AI linked to SQL data and web integration.
